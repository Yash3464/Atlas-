...
const navItems = [
  ...
  { href: "/performance", label: "Performance", icon: InsightsIcon },
  { href: "/recommendations", label: "Recommendations", icon: PolicyIcon },
  { href: "/materials", label: "Study Materials", icon: DocumentIcon },
  { href: "/alerts", label: "Alerts", icon: AuditIcon },
  { href: "/faculty", label: "Faculty View", icon: UsersIcon },
